...
Route::middleware(['auth', 'set.locale', 'current.business'])->group(function () {
    ...
    Route::delete('/example-plugin/records/{record}', [ExampleRecordController::class, 'destroy'])->name('example-plugin.examples.destroy');
    Route::put('/example-plugin/records/{record}/restore', [ExampleRecordController::class, 'restore'])->name('example-plugin.examples.restore');
});
